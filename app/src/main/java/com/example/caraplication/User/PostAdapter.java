package com.example.caraplication.User;
...
import com.example.caraplication.Fragments.ProfileFragment;
import com.example.caraplication.R;
...
//
//                if(user == null) {
//                    System.out.println("NULL -> SAMU");
//                    return;
//                }

                if (user.getImageurl().equals("default")) {
                    holder.imageProfile.setImageResource(R.drawable.ic_person1_foreground);
                } else {
                    Picasso.get().load(user.getImageurl()).placeholder(R.drawable.ic_person1_foreground).into(holder.imageProfile);
                }
...
//                    image.setImageResource(R.drawable.ic_save1_foreground);
//                    image.setTag("saved");
//                }else {
//                    image.setImageResource(R.drawable.ic_save1_foreground);
//                    image.setTag("save");
