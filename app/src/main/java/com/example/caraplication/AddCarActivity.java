    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AddCarActivity.this,FirstActivity.class));
                finish();
            }
        });
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((make.getText().toString().isEmpty()) || (model.getText().toString().isEmpty()) || (year.getText().toString().isEmpty()) || (color.getText().toString().isEmpty()) || (price.getText().toString().isEmpty())){
                    Toast.makeText(AddCarActivity.this,"Please fill all the fields", Toast.LENGTH_SHORT).show();
        ...
        CropImage.activity().start(AddCarActivity.this);
